document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getErrorContainer(field) {
      ...
      return field.parentElement.querySelector('.field-error, .error-message');
    }
    ...
    function validateField(field) {
      ...
      const label =
        ...
        (field.getAttribute('id') &&
          contactForm.querySelector('label[for="' + field.getAttribute('id') + '"]') &&
          contactForm.querySelector('label[for="' + field.getAttribute('id') + '"]').textContent.trim()) ||
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (submitBtn) {
        ...
        submitBtn.textContent = submitBtn.getAttribute('data-submitting-text') || 'Sending…';
      }
      ...
      fetch(action, {
        ...
        .catch(function () {
          ...
          const errorMsg = contactForm.querySelector('.form-error, [data-form-error]');
          if (errorMsg) {
            errorMsg.removeAttribute('hidden');
            errorMsg.setAttribute('role', 'alert');
            errorMsg.textContent =
              errorMsg.getAttribute('data-message') ||
  ...
  const ANIMATE_SELECTOR = '[data-animate], .animate-on-scroll, .fade-in-scroll';

  function applyAnimationDefaults(el) {
    if (!el.hasAttribute(ANIMATE_ATTR)) {
  ...
  if (animatedElements.length > 0) {
    animatedElements.forEach(applyAnimationDefaults);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '290b4528-fde8-4c03-a961-e7762a193c7a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '290b4528-fde8-4c03-a961-e7762a193c7a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '290b4528-fde8-4c03-a961-e7762a193c7a';
